...
import styles from './FAQButtonBanner.module.scss'
    ...
    return (
      <Link href={link}>
        <div
          ...
          onClick={() => searchSetSelectedFAQ(faq, setSelectedFAQ, allFAQ, setAllFAQ)}
        >
...
export default FAQButtonBanner
