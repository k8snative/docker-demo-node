          ...
          <Container className={styles['container']}>
            ...
            <Row className={styles["row"]}>
              <AutoTakafulCards
                image={Accident}
                title="Accidents"
                paragraph="Damages as a result of mishaps, collisions, or crashes"
              />

              <AutoTakafulCards
                image={Theft}
                title="Theft"
                paragraph="Losses incurred in case your car is stolen or snatched"
              />
              <AutoTakafulCards
                image={Fire}
                title="Fire"
                paragraph="Losses due to self-ignition, explosion, lightning"
              />
              <AutoTakafulCards
                image={Natural}
                title="Natural Disaster"
                paragraph="Damages due to natural calamities such as earthquakes, wind, floods, and cyclones"
              />
              <AutoTakafulCards
                image={Damage}
                title="Transit Damages"
                paragraph="Accidents during vehicle transit via road, air, lift, or elevators"
              />
              <AutoTakafulCards
                image={Riots}
                title="Averse Acts and Riots"
                paragraph="Damages due to any tragic event such as riots or strikes"
              />
            </Row>
          </Container>
        </MediaQuery>
        <MediaQuery maxWidth={430}>
          <Container className={styles["mcontainer"]}>
            <p className={styles["mheading"]}>
              What is covered in Auto Takaful?
            </p>
            <p className={styles["mpara"]}>
              {" "}
              Takaful Bazaar’s digital platform and telesales consultants will
              be available round the clock to assist you in all the claim
              processes.
            </p>
            <div>
              <Container fluid>
