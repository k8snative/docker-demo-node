import styles from "./TravelDocumentListTabs.module.scss";
    ...
    <>
      <MediaQuery minWidth={450}>
        <Row>
          <Col md={6}>
            <div
              className={`d-flex mt-5 align-items-center justify-content-center flex-column h-100`}
            >
              <div className="d-flex flex-row align-items-center">
                <p className={styles["documentDamageList"]}>
...
export default TravelDocumentListTabs;
